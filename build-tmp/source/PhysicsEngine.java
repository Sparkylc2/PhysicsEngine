...
public class UI_PropertiesEditorWindow extends UI_Window {
    ...
    private boolean dontChangePauseStateOnChange;
...
*/
    ...
    public void onEditorActive() {
        ...
        if(IS_PAUSED) {
            this.dontChangePauseStateOnChange = true;
            IS_PAUSED_LOCK = true;
        } else {
            IS_PAUSED = true;
            IS_PAUSED_LOCK = true;
            this.dontChangePauseStateOnChange = false;
        }
...
*/
    ...
    public void dragSelect() {
        ...
        if(this.selectedRigidbodies.size() == 0) {
            ...
            if(!dontChangePauseStateOnChange){
                IS_PAUSED = false;
            }
...
*/  
    ...
    public void selectedRigidbodiesOnClick() {
        if(!this.dontChangePauseStateOnChange) {
            IS_PAUSED = false;
        }
        IS_PAUSED_LOCK = false;
        this.clearSelectedRigidbodies();
